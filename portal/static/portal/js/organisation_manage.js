...
function showToggleAdminConfirmation(path, name) {
    title = "Remove teacher";
    text = "<div class='popup-text'><p>The teacher " + name + ", will be made an administrator of this school or club. They will gain all of the powers that you currently have.</p><p>Are you sure?</p></div>";
    confirm_handler = "postWithCsrf('" + path + "')";
    confirm_text = "Confirm";
