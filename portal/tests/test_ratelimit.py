...
from portal.helpers.ratelimit import get_login_ratelimit_count_for_user
...
class TestRatelimit(TestCase):
    ...
    def test_successful_request_resets_cache(self):
        ...
        assert get_login_ratelimit_count_for_user(email) == 3

        # Login successfully
        self._teacher_login(email, password)

        assert get_login_ratelimit_count_for_user(email) is None
        ...
        assert get_login_ratelimit_count_for_user(email) == 1
