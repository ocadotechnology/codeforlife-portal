...
class TestSchoolStudent(BaseTest):
    ...
    def test_reset_password(self):
        ...
        username = create_solo_student(homepage)[2]
        ...
        self.browser.get(self.live_server_url)
        page = HomePage(self.browser).go_to_play_page().go_to_indy_form().solo_login(username, new_password)
        assert self.is_indy_student_details(page)
    ...
    def is_indy_student_details(self, page):
