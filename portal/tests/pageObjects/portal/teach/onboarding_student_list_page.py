...
class OnboardingStudentListPage(TeachBasePage):
    ...
    def is_student_password(self, password):
        return password in self.browser.find_element_by_xpath("//table[@id='student_table']/tbody/tr[4]/td[2]").text
    ...
    def get_first_login_url(self):
        return self.browser.find_element_by_xpath("//table[@id='student_table']/tbody/tr[4]/td[4]/div/div[1]").text
