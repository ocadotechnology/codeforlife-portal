...
from two_factor.views import (LoginView, PhoneDeleteView, PhoneSetupView, DisableView, BackupTokensView, SetupCompleteView, SetupView, ProfileView, QRGeneratorView)
...
from portal.views.organisation import organisation_fuzzy_lookup, organisation_create, organisation_teacher_view, organisation_manage, organisation_leave, organisation_kick, organisation_toggle_admin, organisation_allow_join, organisation_deny_join
from portal.views.play import student_details, student_edit_account, student_join_organisation
from portal.views.registration import custom_2FA_login, password_reset_check_and_confirm, student_password_reset, teacher_password_reset
from portal.views.teach import teacher_home, teacher_lesson_plans, teacher_classes, teacher_class, teacher_move_class, teacher_move_students, teacher_move_students_to_class, teacher_delete_students, teacher_dismiss_students, teacher_edit_class, teacher_delete_class, teacher_student_reset, teacher_edit_student, teacher_edit_account, teacher_disable_2FA, teacher_print_reminder_cards, teacher_accept_student_request, teacher_reject_student_request
...
urlpatterns = patterns('',
    ...
    url(r'^map/$', schools_map, name='map'),
    ...
    url(r'^teach/account/disable_2FA/(?P<pk>[0-9]+)/$', teacher_disable_2FA, name='teacher_disable_2FA'),
    
    url(r'^teach/school/fuzzy_lookup$', organisation_fuzzy_lookup, name='organisation_fuzzy_lookup'),
    ...
    url(r'^teach/school/toggle_admin/(?P<pk>[0-9]+)/$', organisation_toggle_admin, name='organisation_toggle_admin'),
    url(r'^teach/school/allow_join/(?P<pk>[0-9]+)/$', organisation_allow_join, name='organisation_allow_join'),
    url(r'^teach/school/deny_join/(?P<pk>[0-9]+)/$', organisation_deny_join, name='organisation_deny_join'),
    ...
    url(r'^teach/class/(?P<access_code>[A-Z0-9]+)/print_reminder_cards/$', teacher_print_reminder_cards, name='teacher_print_reminder_cards'),
    ...
    url(r'^teach/student/accept/(?P<pk>[0-9]+)/$', teacher_accept_student_request, name='teacher_accept_student_request'),
    url(r'^teach/student/reject/(?P<pk>[0-9]+)/$', teacher_reject_student_request, name='teacher_reject_student_request'),
