...
urlpatterns = patterns('',
    ...
    url(r'^teacher/verify_email/(?P<token>[0-9a-f]+)$', 'portal.views.teacher_verify_email'),
    ...
    url(r'^teacher/class/edit/(?P<pk>[0-9]+)$', 'portal.views.teacher_edit_class'),
    url(r'^teacher/class/reset/(?P<pk>[0-9]+)$', 'portal.views.teacher_student_reset'),
