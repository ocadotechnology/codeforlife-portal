...
urlpatterns = patterns('',
    ...
    url(r'^teach/organisation/toggle_admin/(?P<pk>[0-9]+)/$', 'portal.views.organisation_toggle_admin'),
    ...
    url(r'^teach/class/(?P<access_code>[A-Z0-9]+)/students/move/(?P<new_access_code>[A-Z0-9]+)/$', 'portal.views.teacher_move_students_to_class'),
