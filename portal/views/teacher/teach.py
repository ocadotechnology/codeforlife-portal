...
def materials(request):
    ...
    session_names = ["ks1_session_", "ks2_session_", "lower_ks3_session_", "intermediate_ks3_session_",
                     "upper_ks3_session_"]
    resource_sheets_names = ["KS1_S", "KS2_S", "LOWER_KS3_S", "INTERMEDIATE_KS3_S", "UPPER_KS3_S"]
    ks1_sessions = []
    ks2_sessions = []
    lower_ks3_sessions = []
    intermediate_ks3_sessions = []
    upper_ks3_sessions = []
    session_lists = [ks1_sessions, ks2_sessions, lower_ks3_sessions, intermediate_ks3_sessions, upper_ks3_sessions]
    ks1_sheets = []
    ks2_sheets = []
    lower_ks3_sheets = []
    intermediate_ks3_sheets = []
    upper_ks3_sheets = []
    resource_sheets_lists = [ks1_sheets, ks2_sheets, lower_ks3_sheets, intermediate_ks3_sheets, upper_ks3_sheets]
    ks1_sheets_table = {}
    ks2_sheets_table = {}
    lower_ks3_sheets_table = {}
    intermediate_ks3_sheets_table = {}
    upper_ks3_sheets_table = {}
    resource_sheets_tables = [ks1_sheets_table, ks2_sheets_table, lower_ks3_sheets_table, intermediate_ks3_sheets_table,
                              upper_ks3_sheets_table]
...
def update_session_number_based_on_key_stage(key_stage_name):
    ...
    if key_stage_name == "intermediate_ks3_session_" or key_stage_name == "INTERMEDIATE_KS3_S":
