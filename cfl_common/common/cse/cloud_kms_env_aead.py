...
from tink.integration.gcpkms import GcpKmsClient as _GcpKmsClient
...
class GcpKmsClient(_GcpKmsClient):
    """Basic GCP client for AEAD."""

    def __init__(
        self, key_uri: str, credentials_json: str
    ) -> None:
        ...
        Args:
          ...
          credentials_json: Path to the file with the access credentials. If it is
