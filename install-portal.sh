...
if (( ! $ON_GOOGLE )); then
  cd /tmp
  curl -s https://www.googleapis.com/storage/v1/b/decent-digit-629.appspot.com/o/django-pandasso-1.5.1.tar.gz?alt=media \
  ...
  pip install django-pandasso-1.5.1.tar.gz
  cd -
fi
